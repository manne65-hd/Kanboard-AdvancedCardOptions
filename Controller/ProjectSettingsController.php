...
class ProjectSettingsController extends BaseController
{
    ...
    public function show(array $values = array(), array $errors = array())
    {
        ...
        $this->response->html($this->helper->layout->project('AdvancedCardOptions:project/advanced_card_options', array(
            ...
            'values' => array(
                ...
                'ACO_expanded_description'       => $this->projectMetadataModel->get($project['id'], 'ACO_expanded_description', $this->helper->AdvancedCardOptionsHelper->ACO_defaults['ACO_expanded_description']),
                'ACO_descript_scroller_textsize' => $this->projectMetadataModel->get($project['id'], 'ACO_descript_scroller_textsize', $this->helper->AdvancedCardOptionsHelper->ACO_defaults['ACO_descript_scroller_textsize']),
                'ACO_descript_scroller_maxlines' => $this->projectMetadataModel->get($project['id'], 'ACO_descript_scroller_maxlines', $this->helper->AdvancedCardOptionsHelper->ACO_defaults['ACO_descript_scroller_maxlines']),
    ...
    public function save()
    {
        ...
        $this->projectMetadataModel->save($project['id'], array('ACO_expanded_description' => isset($values["ACO_expanded_description"]) ? $values["ACO_expanded_description"] : 0 ));
        $this->projectMetadataModel->save($project['id'], array('ACO_descript_scroller_textsize' => isset($values["ACO_descript_scroller_textsize"]) ? $values["ACO_descript_scroller_textsize"] : 0 ));
        $this->projectMetadataModel->save($project['id'], array('ACO_descript_scroller_maxlines' => $values["ACO_descript_scroller_maxlines"]));
